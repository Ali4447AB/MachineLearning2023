...
Original file is located at
    https://colab.research.google.com/drive/1VuKOlOVAI96Rg_3C2L7gM0vxaAcattbN
...
X, y = make_classification(n_samples=1000, n_features=2, n_redundant=0, n_clusters_per_class=1, class_sep=2, n_classes=2, random_state=27)
